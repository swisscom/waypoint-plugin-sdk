...
func (x *StaticConfigSource) Reset() {
	*x = StaticConfigSource{}
	if protoimpl.UnsafeEnabled {
...
func (x *StaticConfigSource) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StaticConfigSource) ProtoMessage() {}

func (x *StaticConfigSource) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StaticConfigSource.ProtoReflect.Descriptor instead.
func (*StaticConfigSource) Descriptor() ([]byte, []int) {
...
type StaticConfigSource_ReadResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// values should be exactly equivalent in length to the list of
	// variable requests given to the Read function.
	Values []*StaticConfigSource_Value `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty"`
}

func (x *StaticConfigSource_ReadResponse) Reset() {
	*x = StaticConfigSource_ReadResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StaticConfigSource_ReadResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StaticConfigSource_ReadResponse) ProtoMessage() {}

func (x *StaticConfigSource_ReadResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_msgTypes[83]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StaticConfigSource_ReadResponse.ProtoReflect.Descriptor instead.
func (*StaticConfigSource_ReadResponse) Descriptor() ([]byte, []int) {
	return file_plugin_proto_rawDescGZIP(), []int{20, 0}
}

func (x *StaticConfigSource_ReadResponse) GetValues() []*StaticConfigSource_Value {
	if x != nil {
		return x.Values
	}
	return nil
...
type StaticConfigSource_Value struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Types that are assignable to Result:
	//	*StaticConfigSource_Value_Error
	//	*StaticConfigSource_Value_Value
	Result isStaticConfigSource_Value_Result `protobuf_oneof:"result"`
}

func (x *StaticConfigSource_Value) Reset() {
	*x = StaticConfigSource_Value{}
	if protoimpl.UnsafeEnabled {
...
func (x *StaticConfigSource_Value) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StaticConfigSource_Value) ProtoMessage() {}

func (x *StaticConfigSource_Value) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_msgTypes[84]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StaticConfigSource_Value.ProtoReflect.Descriptor instead.
func (*StaticConfigSource_Value) Descriptor() ([]byte, []int) {
	return file_plugin_proto_rawDescGZIP(), []int{20, 1}
}

func (x *StaticConfigSource_Value) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (m *StaticConfigSource_Value) GetResult() isStaticConfigSource_Value_Result {
	if m != nil {
		return m.Result
	}
	return nil
...
func (x *StaticConfigSource_Value) GetError() *status.Status {
	if x, ok := x.GetResult().(*StaticConfigSource_Value_Error); ok {
		return x.Error
	}
	return nil
}

func (x *StaticConfigSource_Value) GetValue() string {
	if x, ok := x.GetResult().(*StaticConfigSource_Value_Value); ok {
		return x.Value
	}
	return ""
}

type isStaticConfigSource_Value_Result interface {
	isStaticConfigSource_Value_Result()
}

type StaticConfigSource_Value_Error struct {
	// error is an error retrieving this value. Sourcers may also return
	// an error from the entire Read function. The benefit of granular
	// errors is that the runtime may be able to fallback to a default.
	Error *status.Status `protobuf:"bytes,2,opt,name=error,proto3,oneof"`
...
type StaticConfigSource_Value_Value struct {
	// value must be a string value for the config since we currently
	// only support environment variables.
	Value string `protobuf:"bytes,3,opt,name=value,proto3,oneof"`
}

func (*StaticConfigSource_Value_Error) isStaticConfigSource_Value_Result() {}

func (*StaticConfigSource_Value_Value) isStaticConfigSource_Value_Result() {}
...
var file_plugin_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x22, 0xd9, 0x01, 0x0a, 0x12, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0x58, 0x0a, 0x0c, 0x52, 0x65, 0x61,
	0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x48, 0x0a, 0x06, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x68, 0x61, 0x73, 0x68,
	0x69, 0x63, 0x6f, 0x72, 0x70, 0x2e, 0x77, 0x61, 0x79, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x73,
	0x64, 0x6b, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53,
	...
	0x72, 0x70, 0x2e, 0x77, 0x61, 0x79, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x73, 0x64, 0x6b, 0x2e,
	0x50, 0x75, 0x73, 0x68, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x32, 0x8b, 0x0c, 0x0a, 0x0e, 0x52, 0x65,
	...
	0x72, 0x70, 0x2e, 0x77, 0x61, 0x79, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x73, 0x64, 0x6b, 0x2e,
	0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x4a, 0x0a, 0x08,
	...
	0x73, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x32, 0xc4, 0x04, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x66,
...
var file_plugin_proto_goTypes = []interface{}{
	...
	(*StaticConfigSource)(nil),               // 22: hashicorp.waypoint.sdk.StaticConfigSource
	...
	(*Args_DataDir_Project)(nil),             // 33: hashicorp.waypoint.sdk.Args.DataDir.Project
	(*Args_DataDir_App)(nil),                 // 34: hashicorp.waypoint.sdk.Args.DataDir.App
	(*Args_DataDir_Component)(nil),           // 35: hashicorp.waypoint.sdk.Args.DataDir.Component
	(*Args_ReleaseTargets_Target)(nil),       // 36: hashicorp.waypoint.sdk.Args.ReleaseTargets.Target
	nil,                                      // 37: hashicorp.waypoint.sdk.Args.LabelSet.LabelsEntry
	(*FuncSpec_Value)(nil),                   // 38: hashicorp.waypoint.sdk.FuncSpec.Value
	(*FuncSpec_Args)(nil),                    // 39: hashicorp.waypoint.sdk.FuncSpec.Args
	(*Config_ConfigureRequest)(nil),          // 40: hashicorp.waypoint.sdk.Config.ConfigureRequest
	(*Config_StructResp)(nil),                // 41: hashicorp.waypoint.sdk.Config.StructResp
	(*Config_FieldDocumentation)(nil),        // 42: hashicorp.waypoint.sdk.Config.FieldDocumentation
	(*Config_MapperDocumentation)(nil),       // 43: hashicorp.waypoint.sdk.Config.MapperDocumentation
	(*Config_Documentation)(nil),             // 44: hashicorp.waypoint.sdk.Config.Documentation
	nil,                                      // 45: hashicorp.waypoint.sdk.Config.Documentation.FieldsEntry
	nil,                                      // 46: hashicorp.waypoint.sdk.Config.Documentation.TemplateFieldsEntry
	nil,                                      // 47: hashicorp.waypoint.sdk.Config.Documentation.RequestFieldsEntry
	(*Auth_AuthResponse)(nil),                // 48: hashicorp.waypoint.sdk.Auth.AuthResponse
	(*Generation_Resp)(nil),                  // 49: hashicorp.waypoint.sdk.Generation.Resp
	(*Framework_ResourceManagerState)(nil),   // 50: hashicorp.waypoint.sdk.Framework.ResourceManagerState
	(*Framework_ResourceState)(nil),          // 51: hashicorp.waypoint.sdk.Framework.ResourceState
	(*StatusReport_Resource)(nil),            // 52: hashicorp.waypoint.sdk.StatusReport.Resource
	(*ExecSession_OutputRequest)(nil),        // 53: hashicorp.waypoint.sdk.ExecSession.OutputRequest
	(*ExecSession_InputRequest)(nil),         // 54: hashicorp.waypoint.sdk.ExecSession.InputRequest
	(*Logs_Resp)(nil),                        // 55: hashicorp.waypoint.sdk.Logs.Resp
	(*Logs_NextBatchResp)(nil),               // 56: hashicorp.waypoint.sdk.Logs.NextBatchResp
	(*Logs_Event)(nil),                       // 57: hashicorp.waypoint.sdk.Logs.Event
	(*TerminalUI_IsInteractiveResponse)(nil), // 58: hashicorp.waypoint.sdk.TerminalUI.IsInteractiveResponse
	(*TerminalUI_OutputRequest)(nil),         // 59: hashicorp.waypoint.sdk.TerminalUI.OutputRequest
	(*TerminalUI_Response)(nil),              // 60: hashicorp.waypoint.sdk.TerminalUI.Response
	(*TerminalUI_Event)(nil),                 // 61: hashicorp.waypoint.sdk.TerminalUI.Event
	(*TerminalUI_Event_Input)(nil),           // 62: hashicorp.waypoint.sdk.TerminalUI.Event.Input
	(*TerminalUI_Event_InputResp)(nil),       // 63: hashicorp.waypoint.sdk.TerminalUI.Event.InputResp
	(*TerminalUI_Event_Status)(nil),          // 64: hashicorp.waypoint.sdk.TerminalUI.Event.Status
	(*TerminalUI_Event_Line)(nil),            // 65: hashicorp.waypoint.sdk.TerminalUI.Event.Line
	(*TerminalUI_Event_Raw)(nil),             // 66: hashicorp.waypoint.sdk.TerminalUI.Event.Raw
	(*TerminalUI_Event_NamedValue)(nil),      // 67: hashicorp.waypoint.sdk.TerminalUI.Event.NamedValue
	(*TerminalUI_Event_NamedValues)(nil),     // 68: hashicorp.waypoint.sdk.TerminalUI.Event.NamedValues
	(*TerminalUI_Event_TableEntry)(nil),      // 69: hashicorp.waypoint.sdk.TerminalUI.Event.TableEntry
	(*TerminalUI_Event_TableRow)(nil),        // 70: hashicorp.waypoint.sdk.TerminalUI.Event.TableRow
	(*TerminalUI_Event_Table)(nil),           // 71: hashicorp.waypoint.sdk.TerminalUI.Event.Table
	(*TerminalUI_Event_StepGroup)(nil),       // 72: hashicorp.waypoint.sdk.TerminalUI.Event.StepGroup
	(*TerminalUI_Event_Step)(nil),            // 73: hashicorp.waypoint.sdk.TerminalUI.Event.Step
	(*Map_Request)(nil),                      // 74: hashicorp.waypoint.sdk.Map.Request
	(*Map_Response)(nil),                     // 75: hashicorp.waypoint.sdk.Map.Response
	(*Map_ListResponse)(nil),                 // 76: hashicorp.waypoint.sdk.Map.ListResponse
	(*Build_Resp)(nil),                       // 77: hashicorp.waypoint.sdk.Build.Resp
	nil,                                      // 78: hashicorp.waypoint.sdk.Build.Resp.LabelsEntry
	(*DefaultReleaser_Resp)(nil),             // 79: hashicorp.waypoint.sdk.DefaultReleaser.Resp
	(*Deploy_Resp)(nil),                      // 80: hashicorp.waypoint.sdk.Deploy.Resp
	(*Push_Resp)(nil),                        // 81: hashicorp.waypoint.sdk.Push.Resp
	(*Release_Resp)(nil),                     // 82: hashicorp.waypoint.sdk.Release.Resp
	(*ConfigSource_ReadResponse)(nil),        // 83: hashicorp.waypoint.sdk.ConfigSource.ReadResponse
	(*ConfigSource_Value)(nil),               // 84: hashicorp.waypoint.sdk.ConfigSource.Value
	(*StaticConfigSource_ReadResponse)(nil),  // 85: hashicorp.waypoint.sdk.StaticConfigSource.ReadResponse
	(*StaticConfigSource_Value)(nil),         // 86: hashicorp.waypoint.sdk.StaticConfigSource.Value
...
var file_plugin_proto_depIdxs = []int32{
	38,  // 0: hashicorp.waypoint.sdk.FuncSpec.args:type_name -> hashicorp.waypoint.sdk.FuncSpec.Value
	38,  // 1: hashicorp.waypoint.sdk.FuncSpec.result:type_name -> hashicorp.waypoint.sdk.FuncSpec.Value
	52,  // 2: hashicorp.waypoint.sdk.StatusReport.resources:type_name -> hashicorp.waypoint.sdk.StatusReport.Resource
	1,   // 3: hashicorp.waypoint.sdk.StatusReport.health:type_name -> hashicorp.waypoint.sdk.StatusReport.Health
	87,  // 4: hashicorp.waypoint.sdk.StatusReport.time_generated:type_name -> google.protobuf.Timestamp
	36,  // 5: hashicorp.waypoint.sdk.Args.ReleaseTargets.targets:type_name -> hashicorp.waypoint.sdk.Args.ReleaseTargets.Target
	37,  // 6: hashicorp.waypoint.sdk.Args.LabelSet.labels:type_name -> hashicorp.waypoint.sdk.Args.LabelSet.LabelsEntry
	10,  // 7: hashicorp.waypoint.sdk.Args.ExecSessionInfo.initial_window:type_name -> hashicorp.waypoint.sdk.WindowSize
	87,  // 8: hashicorp.waypoint.sdk.Args.LogViewer.starting_at:type_name -> google.protobuf.Timestamp
	88,  // 9: hashicorp.waypoint.sdk.Args.ReleaseTargets.Target.deployment:type_name -> google.protobuf.Any
	0,   // 10: hashicorp.waypoint.sdk.FuncSpec.Value.primitive_type:type_name -> hashicorp.waypoint.sdk.FuncSpec.Value.PrimitiveType
	88,  // 11: hashicorp.waypoint.sdk.FuncSpec.Value.proto_any:type_name -> google.protobuf.Any
	38,  // 12: hashicorp.waypoint.sdk.FuncSpec.Args.args:type_name -> hashicorp.waypoint.sdk.FuncSpec.Value
	89,  // 13: hashicorp.waypoint.sdk.Config.StructResp.struct:type_name -> protostructure.Struct
	42,  // 14: hashicorp.waypoint.sdk.Config.FieldDocumentation.sub_fields:type_name -> hashicorp.waypoint.sdk.Config.FieldDocumentation
	45,  // 15: hashicorp.waypoint.sdk.Config.Documentation.fields:type_name -> hashicorp.waypoint.sdk.Config.Documentation.FieldsEntry
	46,  // 16: hashicorp.waypoint.sdk.Config.Documentation.template_fields:type_name -> hashicorp.waypoint.sdk.Config.Documentation.TemplateFieldsEntry
	47,  // 17: hashicorp.waypoint.sdk.Config.Documentation.request_fields:type_name -> hashicorp.waypoint.sdk.Config.Documentation.RequestFieldsEntry
	43,  // 18: hashicorp.waypoint.sdk.Config.Documentation.mappers:type_name -> hashicorp.waypoint.sdk.Config.MapperDocumentation
	42,  // 19: hashicorp.waypoint.sdk.Config.Documentation.FieldsEntry.value:type_name -> hashicorp.waypoint.sdk.Config.FieldDocumentation
	42,  // 20: hashicorp.waypoint.sdk.Config.Documentation.TemplateFieldsEntry.value:type_name -> hashicorp.waypoint.sdk.Config.FieldDocumentation
	42,  // 21: hashicorp.waypoint.sdk.Config.Documentation.RequestFieldsEntry.value:type_name -> hashicorp.waypoint.sdk.Config.FieldDocumentation
	51,  // 22: hashicorp.waypoint.sdk.Framework.ResourceManagerState.resources:type_name -> hashicorp.waypoint.sdk.Framework.ResourceState
	88,  // 23: hashicorp.waypoint.sdk.Framework.ResourceState.raw:type_name -> google.protobuf.Any
	...
	57,  // 26: hashicorp.waypoint.sdk.Logs.NextBatchResp.events:type_name -> hashicorp.waypoint.sdk.Logs.Event
	87,  // 27: hashicorp.waypoint.sdk.Logs.Event.timestamp:type_name -> google.protobuf.Timestamp
	63,  // 28: hashicorp.waypoint.sdk.TerminalUI.Response.input:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.InputResp
	65,  // 29: hashicorp.waypoint.sdk.TerminalUI.Event.line:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.Line
	64,  // 30: hashicorp.waypoint.sdk.TerminalUI.Event.status:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.Status
	68,  // 31: hashicorp.waypoint.sdk.TerminalUI.Event.named_values:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.NamedValues
	66,  // 32: hashicorp.waypoint.sdk.TerminalUI.Event.raw:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.Raw
	71,  // 33: hashicorp.waypoint.sdk.TerminalUI.Event.table:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.Table
	72,  // 34: hashicorp.waypoint.sdk.TerminalUI.Event.step_group:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.StepGroup
	73,  // 35: hashicorp.waypoint.sdk.TerminalUI.Event.step:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.Step
	62,  // 36: hashicorp.waypoint.sdk.TerminalUI.Event.input:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.Input
	90,  // 37: hashicorp.waypoint.sdk.TerminalUI.Event.InputResp.error:type_name -> google.rpc.Status
	67,  // 38: hashicorp.waypoint.sdk.TerminalUI.Event.NamedValues.values:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.NamedValue
	69,  // 39: hashicorp.waypoint.sdk.TerminalUI.Event.TableRow.entries:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.TableEntry
	70,  // 40: hashicorp.waypoint.sdk.TerminalUI.Event.Table.rows:type_name -> hashicorp.waypoint.sdk.TerminalUI.Event.TableRow
	39,  // 41: hashicorp.waypoint.sdk.Map.Request.args:type_name -> hashicorp.waypoint.sdk.FuncSpec.Args
	88,  // 42: hashicorp.waypoint.sdk.Map.Response.result:type_name -> google.protobuf.Any
	3,   // 43: hashicorp.waypoint.sdk.Map.ListResponse.funcs:type_name -> hashicorp.waypoint.sdk.FuncSpec
	88,  // 44: hashicorp.waypoint.sdk.Build.Resp.result:type_name -> google.protobuf.Any
	78,  // 45: hashicorp.waypoint.sdk.Build.Resp.labels:type_name -> hashicorp.waypoint.sdk.Build.Resp.LabelsEntry
	88,  // 46: hashicorp.waypoint.sdk.Deploy.Resp.result:type_name -> google.protobuf.Any
	88,  // 47: hashicorp.waypoint.sdk.Push.Resp.result:type_name -> google.protobuf.Any
	88,  // 48: hashicorp.waypoint.sdk.Release.Resp.result:type_name -> google.protobuf.Any
	20,  // 49: hashicorp.waypoint.sdk.Release.Resp.release:type_name -> hashicorp.waypoint.sdk.Release
	84,  // 50: hashicorp.waypoint.sdk.ConfigSource.ReadResponse.values:type_name -> hashicorp.waypoint.sdk.ConfigSource.Value
	90,  // 51: hashicorp.waypoint.sdk.ConfigSource.Value.error:type_name -> google.rpc.Status
	86,  // 52: hashicorp.waypoint.sdk.StaticConfigSource.ReadResponse.values:type_name -> hashicorp.waypoint.sdk.StaticConfigSource.Value
	90,  // 53: hashicorp.waypoint.sdk.StaticConfigSource.Value.error:type_name -> google.rpc.Status
	53,  // 54: hashicorp.waypoint.sdk.ExecSessionService.Output:input_type -> hashicorp.waypoint.sdk.ExecSession.OutputRequest
	91,  // 55: hashicorp.waypoint.sdk.ExecSessionService.Input:input_type -> google.protobuf.Empty
	56,  // 56: hashicorp.waypoint.sdk.LogViewer.NextLogBatch:input_type -> hashicorp.waypoint.sdk.Logs.NextBatchResp
	59,  // 57: hashicorp.waypoint.sdk.TerminalUIService.Output:input_type -> hashicorp.waypoint.sdk.TerminalUI.OutputRequest
	61,  // 58: hashicorp.waypoint.sdk.TerminalUIService.Events:input_type -> hashicorp.waypoint.sdk.TerminalUI.Event
	91,  // 59: hashicorp.waypoint.sdk.TerminalUIService.IsInteractive:input_type -> google.protobuf.Empty
	91,  // 60: hashicorp.waypoint.sdk.Mapper.ListMappers:input_type -> google.protobuf.Empty
	74,  // 61: hashicorp.waypoint.sdk.Mapper.Map:input_type -> hashicorp.waypoint.sdk.Map.Request
	91,  // 62: hashicorp.waypoint.sdk.Builder.IsAuthenticator:input_type -> google.protobuf.Empty
	39,  // 63: hashicorp.waypoint.sdk.Builder.Auth:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 64: hashicorp.waypoint.sdk.Builder.AuthSpec:input_type -> google.protobuf.Empty
	39,  // 65: hashicorp.waypoint.sdk.Builder.ValidateAuth:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 66: hashicorp.waypoint.sdk.Builder.ValidateAuthSpec:input_type -> google.protobuf.Empty
	91,  // 67: hashicorp.waypoint.sdk.Builder.ConfigStruct:input_type -> google.protobuf.Empty
	40,  // 68: hashicorp.waypoint.sdk.Builder.Configure:input_type -> hashicorp.waypoint.sdk.Config.ConfigureRequest
	91,  // 69: hashicorp.waypoint.sdk.Builder.Documentation:input_type -> google.protobuf.Empty
	91,  // 70: hashicorp.waypoint.sdk.Builder.BuildSpec:input_type -> google.protobuf.Empty
	39,  // 71: hashicorp.waypoint.sdk.Builder.Build:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 72: hashicorp.waypoint.sdk.Platform.IsAuthenticator:input_type -> google.protobuf.Empty
	39,  // 73: hashicorp.waypoint.sdk.Platform.Auth:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 74: hashicorp.waypoint.sdk.Platform.AuthSpec:input_type -> google.protobuf.Empty
	39,  // 75: hashicorp.waypoint.sdk.Platform.ValidateAuth:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 76: hashicorp.waypoint.sdk.Platform.ValidateAuthSpec:input_type -> google.protobuf.Empty
	91,  // 77: hashicorp.waypoint.sdk.Platform.ConfigStruct:input_type -> google.protobuf.Empty
	40,  // 78: hashicorp.waypoint.sdk.Platform.Configure:input_type -> hashicorp.waypoint.sdk.Config.ConfigureRequest
	91,  // 79: hashicorp.waypoint.sdk.Platform.Documentation:input_type -> google.protobuf.Empty
	91,  // 80: hashicorp.waypoint.sdk.Platform.DeploySpec:input_type -> google.protobuf.Empty
	39,  // 81: hashicorp.waypoint.sdk.Platform.Deploy:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 82: hashicorp.waypoint.sdk.Platform.DefaultReleaserSpec:input_type -> google.protobuf.Empty
	39,  // 83: hashicorp.waypoint.sdk.Platform.DefaultReleaser:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 84: hashicorp.waypoint.sdk.Platform.IsDestroyer:input_type -> google.protobuf.Empty
	91,  // 85: hashicorp.waypoint.sdk.Platform.DestroySpec:input_type -> google.protobuf.Empty
	39,  // 86: hashicorp.waypoint.sdk.Platform.Destroy:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 87: hashicorp.waypoint.sdk.Platform.IsWorkspaceDestroyer:input_type -> google.protobuf.Empty
	91,  // 88: hashicorp.waypoint.sdk.Platform.DestroyWorkspaceSpec:input_type -> google.protobuf.Empty
	39,  // 89: hashicorp.waypoint.sdk.Platform.DestroyWorkspace:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 90: hashicorp.waypoint.sdk.Platform.IsExecer:input_type -> google.protobuf.Empty
	91,  // 91: hashicorp.waypoint.sdk.Platform.ExecSpec:input_type -> google.protobuf.Empty
	39,  // 92: hashicorp.waypoint.sdk.Platform.Exec:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 93: hashicorp.waypoint.sdk.Platform.IsLogPlatform:input_type -> google.protobuf.Empty
	91,  // 94: hashicorp.waypoint.sdk.Platform.LogsSpec:input_type -> google.protobuf.Empty
	39,  // 95: hashicorp.waypoint.sdk.Platform.Logs:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 96: hashicorp.waypoint.sdk.Platform.IsGeneration:input_type -> google.protobuf.Empty
	91,  // 97: hashicorp.waypoint.sdk.Platform.GenerationSpec:input_type -> google.protobuf.Empty
	39,  // 98: hashicorp.waypoint.sdk.Platform.Generation:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 99: hashicorp.waypoint.sdk.Platform.IsStatus:input_type -> google.protobuf.Empty
	91,  // 100: hashicorp.waypoint.sdk.Platform.StatusSpec:input_type -> google.protobuf.Empty
	39,  // 101: hashicorp.waypoint.sdk.Platform.Status:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 102: hashicorp.waypoint.sdk.Registry.IsAuthenticator:input_type -> google.protobuf.Empty
	39,  // 103: hashicorp.waypoint.sdk.Registry.Auth:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 104: hashicorp.waypoint.sdk.Registry.AuthSpec:input_type -> google.protobuf.Empty
	39,  // 105: hashicorp.waypoint.sdk.Registry.ValidateAuth:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 106: hashicorp.waypoint.sdk.Registry.ValidateAuthSpec:input_type -> google.protobuf.Empty
	91,  // 107: hashicorp.waypoint.sdk.Registry.ConfigStruct:input_type -> google.protobuf.Empty
	40,  // 108: hashicorp.waypoint.sdk.Registry.Configure:input_type -> hashicorp.waypoint.sdk.Config.ConfigureRequest
	91,  // 109: hashicorp.waypoint.sdk.Registry.Documentation:input_type -> google.protobuf.Empty
	91,  // 110: hashicorp.waypoint.sdk.Registry.PushSpec:input_type -> google.protobuf.Empty
	39,  // 111: hashicorp.waypoint.sdk.Registry.Push:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 112: hashicorp.waypoint.sdk.ReleaseManager.IsAuthenticator:input_type -> google.protobuf.Empty
	39,  // 113: hashicorp.waypoint.sdk.ReleaseManager.Auth:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 114: hashicorp.waypoint.sdk.ReleaseManager.AuthSpec:input_type -> google.protobuf.Empty
	39,  // 115: hashicorp.waypoint.sdk.ReleaseManager.ValidateAuth:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 116: hashicorp.waypoint.sdk.ReleaseManager.ValidateAuthSpec:input_type -> google.protobuf.Empty
	91,  // 117: hashicorp.waypoint.sdk.ReleaseManager.ConfigStruct:input_type -> google.protobuf.Empty
	40,  // 118: hashicorp.waypoint.sdk.ReleaseManager.Configure:input_type -> hashicorp.waypoint.sdk.Config.ConfigureRequest
	91,  // 119: hashicorp.waypoint.sdk.ReleaseManager.Documentation:input_type -> google.protobuf.Empty
	91,  // 120: hashicorp.waypoint.sdk.ReleaseManager.IsDestroyer:input_type -> google.protobuf.Empty
	91,  // 121: hashicorp.waypoint.sdk.ReleaseManager.DestroySpec:input_type -> google.protobuf.Empty
	39,  // 122: hashicorp.waypoint.sdk.ReleaseManager.Destroy:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 123: hashicorp.waypoint.sdk.ReleaseManager.IsWorkspaceDestroyer:input_type -> google.protobuf.Empty
	91,  // 124: hashicorp.waypoint.sdk.ReleaseManager.DestroyWorkspaceSpec:input_type -> google.protobuf.Empty
	39,  // 125: hashicorp.waypoint.sdk.ReleaseManager.DestroyWorkspace:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 126: hashicorp.waypoint.sdk.ReleaseManager.ReleaseSpec:input_type -> google.protobuf.Empty
	39,  // 127: hashicorp.waypoint.sdk.ReleaseManager.Release:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 128: hashicorp.waypoint.sdk.ReleaseManager.IsStatus:input_type -> google.protobuf.Empty
	91,  // 129: hashicorp.waypoint.sdk.ReleaseManager.StatusSpec:input_type -> google.protobuf.Empty
	39,  // 130: hashicorp.waypoint.sdk.ReleaseManager.Status:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 131: hashicorp.waypoint.sdk.ConfigSourcer.ConfigStruct:input_type -> google.protobuf.Empty
	40,  // 132: hashicorp.waypoint.sdk.ConfigSourcer.Configure:input_type -> hashicorp.waypoint.sdk.Config.ConfigureRequest
	91,  // 133: hashicorp.waypoint.sdk.ConfigSourcer.Documentation:input_type -> google.protobuf.Empty
	91,  // 134: hashicorp.waypoint.sdk.ConfigSourcer.ReadSpec:input_type -> google.protobuf.Empty
	39,  // 135: hashicorp.waypoint.sdk.ConfigSourcer.Read:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 136: hashicorp.waypoint.sdk.ConfigSourcer.StopSpec:input_type -> google.protobuf.Empty
	39,  // 137: hashicorp.waypoint.sdk.ConfigSourcer.Stop:input_type -> hashicorp.waypoint.sdk.FuncSpec.Args
	91,  // 138: hashicorp.waypoint.sdk.ExecSessionService.Output:output_type -> google.protobuf.Empty
	54,  // 139: hashicorp.waypoint.sdk.ExecSessionService.Input:output_type -> hashicorp.waypoint.sdk.ExecSession.InputRequest
	91,  // 140: hashicorp.waypoint.sdk.LogViewer.NextLogBatch:output_type -> google.protobuf.Empty
	91,  // 141: hashicorp.waypoint.sdk.TerminalUIService.Output:output_type -> google.protobuf.Empty
	60,  // 142: hashicorp.waypoint.sdk.TerminalUIService.Events:output_type -> hashicorp.waypoint.sdk.TerminalUI.Response
	58,  // 143: hashicorp.waypoint.sdk.TerminalUIService.IsInteractive:output_type -> hashicorp.waypoint.sdk.TerminalUI.IsInteractiveResponse
	76,  // 144: hashicorp.waypoint.sdk.Mapper.ListMappers:output_type -> hashicorp.waypoint.sdk.Map.ListResponse
	75,  // 145: hashicorp.waypoint.sdk.Mapper.Map:output_type -> hashicorp.waypoint.sdk.Map.Response
	7,   // 146: hashicorp.waypoint.sdk.Builder.IsAuthenticator:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	48,  // 147: hashicorp.waypoint.sdk.Builder.Auth:output_type -> hashicorp.waypoint.sdk.Auth.AuthResponse
	3,   // 148: hashicorp.waypoint.sdk.Builder.AuthSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 149: hashicorp.waypoint.sdk.Builder.ValidateAuth:output_type -> google.protobuf.Empty
	3,   // 150: hashicorp.waypoint.sdk.Builder.ValidateAuthSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	41,  // 151: hashicorp.waypoint.sdk.Builder.ConfigStruct:output_type -> hashicorp.waypoint.sdk.Config.StructResp
	91,  // 152: hashicorp.waypoint.sdk.Builder.Configure:output_type -> google.protobuf.Empty
	44,  // 153: hashicorp.waypoint.sdk.Builder.Documentation:output_type -> hashicorp.waypoint.sdk.Config.Documentation
	3,   // 154: hashicorp.waypoint.sdk.Builder.BuildSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	77,  // 155: hashicorp.waypoint.sdk.Builder.Build:output_type -> hashicorp.waypoint.sdk.Build.Resp
	7,   // 156: hashicorp.waypoint.sdk.Platform.IsAuthenticator:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	48,  // 157: hashicorp.waypoint.sdk.Platform.Auth:output_type -> hashicorp.waypoint.sdk.Auth.AuthResponse
	3,   // 158: hashicorp.waypoint.sdk.Platform.AuthSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 159: hashicorp.waypoint.sdk.Platform.ValidateAuth:output_type -> google.protobuf.Empty
	3,   // 160: hashicorp.waypoint.sdk.Platform.ValidateAuthSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	41,  // 161: hashicorp.waypoint.sdk.Platform.ConfigStruct:output_type -> hashicorp.waypoint.sdk.Config.StructResp
	91,  // 162: hashicorp.waypoint.sdk.Platform.Configure:output_type -> google.protobuf.Empty
	44,  // 163: hashicorp.waypoint.sdk.Platform.Documentation:output_type -> hashicorp.waypoint.sdk.Config.Documentation
	3,   // 164: hashicorp.waypoint.sdk.Platform.DeploySpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	80,  // 165: hashicorp.waypoint.sdk.Platform.Deploy:output_type -> hashicorp.waypoint.sdk.Deploy.Resp
	3,   // 166: hashicorp.waypoint.sdk.Platform.DefaultReleaserSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	79,  // 167: hashicorp.waypoint.sdk.Platform.DefaultReleaser:output_type -> hashicorp.waypoint.sdk.DefaultReleaser.Resp
	7,   // 168: hashicorp.waypoint.sdk.Platform.IsDestroyer:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	3,   // 169: hashicorp.waypoint.sdk.Platform.DestroySpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 170: hashicorp.waypoint.sdk.Platform.Destroy:output_type -> google.protobuf.Empty
	7,   // 171: hashicorp.waypoint.sdk.Platform.IsWorkspaceDestroyer:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	3,   // 172: hashicorp.waypoint.sdk.Platform.DestroyWorkspaceSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 173: hashicorp.waypoint.sdk.Platform.DestroyWorkspace:output_type -> google.protobuf.Empty
	7,   // 174: hashicorp.waypoint.sdk.Platform.IsExecer:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	3,   // 175: hashicorp.waypoint.sdk.Platform.ExecSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	12,  // 176: hashicorp.waypoint.sdk.Platform.Exec:output_type -> hashicorp.waypoint.sdk.ExecResult
	7,   // 177: hashicorp.waypoint.sdk.Platform.IsLogPlatform:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	3,   // 178: hashicorp.waypoint.sdk.Platform.LogsSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 179: hashicorp.waypoint.sdk.Platform.Logs:output_type -> google.protobuf.Empty
	7,   // 180: hashicorp.waypoint.sdk.Platform.IsGeneration:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	3,   // 181: hashicorp.waypoint.sdk.Platform.GenerationSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	49,  // 182: hashicorp.waypoint.sdk.Platform.Generation:output_type -> hashicorp.waypoint.sdk.Generation.Resp
	7,   // 183: hashicorp.waypoint.sdk.Platform.IsStatus:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	3,   // 184: hashicorp.waypoint.sdk.Platform.StatusSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	9,   // 185: hashicorp.waypoint.sdk.Platform.Status:output_type -> hashicorp.waypoint.sdk.StatusReport
	7,   // 186: hashicorp.waypoint.sdk.Registry.IsAuthenticator:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	48,  // 187: hashicorp.waypoint.sdk.Registry.Auth:output_type -> hashicorp.waypoint.sdk.Auth.AuthResponse
	3,   // 188: hashicorp.waypoint.sdk.Registry.AuthSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 189: hashicorp.waypoint.sdk.Registry.ValidateAuth:output_type -> google.protobuf.Empty
	3,   // 190: hashicorp.waypoint.sdk.Registry.ValidateAuthSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	41,  // 191: hashicorp.waypoint.sdk.Registry.ConfigStruct:output_type -> hashicorp.waypoint.sdk.Config.StructResp
	91,  // 192: hashicorp.waypoint.sdk.Registry.Configure:output_type -> google.protobuf.Empty
	44,  // 193: hashicorp.waypoint.sdk.Registry.Documentation:output_type -> hashicorp.waypoint.sdk.Config.Documentation
	3,   // 194: hashicorp.waypoint.sdk.Registry.PushSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	81,  // 195: hashicorp.waypoint.sdk.Registry.Push:output_type -> hashicorp.waypoint.sdk.Push.Resp
	7,   // 196: hashicorp.waypoint.sdk.ReleaseManager.IsAuthenticator:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	48,  // 197: hashicorp.waypoint.sdk.ReleaseManager.Auth:output_type -> hashicorp.waypoint.sdk.Auth.AuthResponse
	3,   // 198: hashicorp.waypoint.sdk.ReleaseManager.AuthSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 199: hashicorp.waypoint.sdk.ReleaseManager.ValidateAuth:output_type -> google.protobuf.Empty
	3,   // 200: hashicorp.waypoint.sdk.ReleaseManager.ValidateAuthSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	41,  // 201: hashicorp.waypoint.sdk.ReleaseManager.ConfigStruct:output_type -> hashicorp.waypoint.sdk.Config.StructResp
	91,  // 202: hashicorp.waypoint.sdk.ReleaseManager.Configure:output_type -> google.protobuf.Empty
	44,  // 203: hashicorp.waypoint.sdk.ReleaseManager.Documentation:output_type -> hashicorp.waypoint.sdk.Config.Documentation
	7,   // 204: hashicorp.waypoint.sdk.ReleaseManager.IsDestroyer:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	3,   // 205: hashicorp.waypoint.sdk.ReleaseManager.DestroySpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 206: hashicorp.waypoint.sdk.ReleaseManager.Destroy:output_type -> google.protobuf.Empty
	7,   // 207: hashicorp.waypoint.sdk.ReleaseManager.IsWorkspaceDestroyer:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	3,   // 208: hashicorp.waypoint.sdk.ReleaseManager.DestroyWorkspaceSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 209: hashicorp.waypoint.sdk.ReleaseManager.DestroyWorkspace:output_type -> google.protobuf.Empty
	3,   // 210: hashicorp.waypoint.sdk.ReleaseManager.ReleaseSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	82,  // 211: hashicorp.waypoint.sdk.ReleaseManager.Release:output_type -> hashicorp.waypoint.sdk.Release.Resp
	7,   // 212: hashicorp.waypoint.sdk.ReleaseManager.IsStatus:output_type -> hashicorp.waypoint.sdk.ImplementsResp
	3,   // 213: hashicorp.waypoint.sdk.ReleaseManager.StatusSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	9,   // 214: hashicorp.waypoint.sdk.ReleaseManager.Status:output_type -> hashicorp.waypoint.sdk.StatusReport
	41,  // 215: hashicorp.waypoint.sdk.ConfigSourcer.ConfigStruct:output_type -> hashicorp.waypoint.sdk.Config.StructResp
	91,  // 216: hashicorp.waypoint.sdk.ConfigSourcer.Configure:output_type -> google.protobuf.Empty
	44,  // 217: hashicorp.waypoint.sdk.ConfigSourcer.Documentation:output_type -> hashicorp.waypoint.sdk.Config.Documentation
	3,   // 218: hashicorp.waypoint.sdk.ConfigSourcer.ReadSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	83,  // 219: hashicorp.waypoint.sdk.ConfigSourcer.Read:output_type -> hashicorp.waypoint.sdk.ConfigSource.ReadResponse
	3,   // 220: hashicorp.waypoint.sdk.ConfigSourcer.StopSpec:output_type -> hashicorp.waypoint.sdk.FuncSpec
	91,  // 221: hashicorp.waypoint.sdk.ConfigSourcer.Stop:output_type -> google.protobuf.Empty
	138, // [138:222] is the sub-list for method output_type
	54,  // [54:138] is the sub-list for method input_type
...
func file_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_plugin_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StaticConfigSource); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_plugin_proto_msgTypes[83].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StaticConfigSource_ReadResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_plugin_proto_msgTypes[84].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StaticConfigSource_Value); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_plugin_proto_msgTypes[82].OneofWrappers = []interface{}{
		(*ConfigSource_Value_Error)(nil),
		(*ConfigSource_Value_Value)(nil),
	}
	file_plugin_proto_msgTypes[84].OneofWrappers = []interface{}{
		(*StaticConfigSource_Value_Error)(nil),
		(*StaticConfigSource_Value_Value)(nil),
	}
	type x struct{}
